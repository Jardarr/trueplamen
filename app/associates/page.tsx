        ...
        <div className="custom-font flex justify-center pt-10 sm:py-7 bg-main-bg bg-cover bg-fixed bg-top bg-no-repeat min-h-screen sm:h-fit">
            <div className="max-w-[1200px] w-full flex flex-col gap-3 text-gray-300">
                ...
                <div className="w-full flex flex-col sm:flex-row gap-3">
                    ...
                    <div className="bg-neutral-900/45 p-3 mx-4 rounded-md h-[180px]">
                        <Link className="text-center flex flex-col items-center" href="https://youtube.com/@amkrafter?si=AHkoItXkTWDd1LWU" target="_blank"><Image className="w-[120px] h-[153px] hover:scale-110 transition-transform ease-in-out" src="/associates-img/saturn.png" alt="saturn" width={100} height={300} /><p className="pt-2">Saturn</p></Link>
                    </div>
                </div>
            </div>
        </div>
