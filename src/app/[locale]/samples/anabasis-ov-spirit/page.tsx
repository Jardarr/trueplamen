...
import anabasisOvSpirit from "./anabasisOvSpirit.utils";
...
export const metadata: Metadata = {
    title: "Plamen | Anabasis Ov Spirit",
    description: "Anabasis Ov Spirit. You have come into this world to blaze in the sun of the City... And the fiercer the evil, the brighter burns the flame of pure hearts!",
...
const AnabasisOvSpirit = () => {
    ...
    const tracklist = t("Release.AnabasisOvSpirit.tracklist");
        ...
        <div className="custom-font relative w-full flex flex-col items-center gap-8 pt-10 sm:justify-center pb-20 bg-main-bg bg-cover bg-fixed bg-top bg-no-repeat min-h-screen sm:h-fit">
            <div className="max-w-[900px] w-full flex flex-col sm:flex-row">
                <div className="flex flex-col items-center bg-neutral-800/45 p-3 rounded-md">
                    <AlbumCards
                        image={{ src: album.imageBIG, alt: album.alt, width: 500, height: 400, className: "rounded-md rounded-md px-12 md:px-0 flex-1" }}
                        skeleton={{ className: "rounded-md rounded-md px-12 md:px-0 flex-1 w-[300px] h-[260px] sm:w-[500px] sm:h-[400px]" }}
                    />
                    <h1 className="text-gray-300 text-base">{t(`Release.AnabasisOvSpirit.title`)}</h1>
                    <h2 className="text-gray-400 text-sm text-center font-thin">{t("Release.AnabasisOvSpirit.description")}</h2>
                </div>
