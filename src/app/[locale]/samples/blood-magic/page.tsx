...
export const metadata: Metadata = {
	title: "Plamen | Blood Magic",
	description: "Blood Magic. You have come into this world to blaze in the sun of the City... And the fiercer the evil, the brighter burns the flame of pure hearts!",
...
const BloodMagic = () => {
	...
	const tracklist = t("Release.BloodMagic.tracklist");
