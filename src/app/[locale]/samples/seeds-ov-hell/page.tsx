...
import seedsOvHell from "./seedsOvHell.utils";
...
export const metadata: Metadata = {
	title: "Plamen | Seeds Ov Hell",
	description: "Seeds Ov Hell. You have come into this world to blaze in the sun of the City... And the fiercer the evil, the brighter burns the flame of pure hearts!",
...
const SeedsOvHell = () => {
	...
	const album = seedsOvHell[0];
	const audio = album.audio ?? "";
	const audioTitle = album.audioTitle ?? "";
	const tracklist = t("Release.SeedsOvHell.tracklist");
		...
		<div className="custom-font relative w-full flex flex-col items-center gap-8 pt-10 sm:justify-center pb-20 bg-main-bg bg-cover bg-fixed bg-top bg-no-repeat min-h-screen sm:h-fit">
			<div className="max-w-[900px] w-full flex flex-col sm:flex-row">
				<div className="flex flex-col items-center bg-neutral-800/45 p-3 rounded-md">
					...
					<h1 className="text-gray-300 text-base">{t(`Release.SeedsOvHell.title`)}</h1>
					<h2 className="text-gray-400 text-sm text-center font-thin">{t("Release.SeedsOvHell.description")}</h2>
				</div>
