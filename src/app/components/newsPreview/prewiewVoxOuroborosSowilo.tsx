...
export default function PreviewVoxOuroborosSowilo() {
	const t = useTranslations("SowiloPrewiew");
			...
			<div className="news-box bg-neutral-900 rounded-md">
				<Link href="/news/vox-ouroboros-sowilo" className="overflow-hidden flex flex-col sm:flex-row justify-between items-center">
					<div className="w-full h-[180px] sm:w-[200px] sm:h-[200px]">
						<Image className="h-full w-full object-cover rounded-t-md sm:rounded-l-md sm:rounded-r-none" src="/covers/vox-ouroboros-sowilo-BIG.jpg" alt="" width={150} height={150} />
					</div>
